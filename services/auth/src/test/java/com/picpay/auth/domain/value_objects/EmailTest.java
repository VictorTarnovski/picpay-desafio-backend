...
class EmailTest {
    @Test
    void given_a_valid_input_when_creating_a_email_then_should_create_email() {
        var faker = new Faker();
        // given
    ...
    @Test
    void given_a_invalid_input_when_creating_a_email_then_should_not_create_email() {
        var faker = new Faker();
        // given
    ...
    @Test
    void given_a_null_email_when_creating_a_email_then_should_not_create_email() {
        // given
        String input = null;
